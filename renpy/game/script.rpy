...
label start:
    ...
    c "胜利不是结束。胜利只是让所有人开始计算下一次背叛的日子。"
    m "陛下，猫族残部尚有俘虏。依臣之见，应当今夜处决，以绝后患。"
    "老书记官低声提醒：笼子能关住身体，却关不住一个愿意等待的人。若要一个人留下，靠的从来不是锁。"
    ...
    "几秒后，黑暗中传来极轻的脚步声。她没有奔向门口，而是先绕到书桌前。爪子拨开边境地图，停在猫族旧王都的位置。"
    c "那座城不是被我烧掉的。至少，不全是。"
    ...
    c "别这样看我。我还没高尚到能放你走。"
    "她绕开他的手，最后却选在离他书桌半步远的地毯上蜷下。不是原谅，只是暂时不走。"
    ...
    c "都有。"
    "这句诚实比谎言更伤人。塞德里克立刻知道自己错了。王习惯把真心藏进刀鞘里，可不是每个人都该被刀柄碰到。"
